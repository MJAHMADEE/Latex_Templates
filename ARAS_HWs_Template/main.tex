...
\pagestyle{fancy}
\fancyhf{}
\rhead{\includegraphics[width=2cm]{ARASLogo} پاسخ تمرین/تحقیق صفرم درس کنترل صنعتی}
\lhead{\thepage}
\rfoot{سیدمحمد حسینی}
\lfoot{9901399}
...
\bibitem{b1} \href{https://aras.kntu.ac.ir/arascourses/industrial-control/}{صفحۀ درس کنترل صنعتی.}
\begin{LTRitems}
\resetlatinfont
\bibitem{b2} Advanced PID Control, K.J. Astrom, and T. Hagglund, Third Edition, Inst. Soc. America, TJ 223.P55A85, 2006.
\bibitem{b3} Control Engineering, A Modern Approach, P.R. Belanger, Saunders College Pub. 1995.
\end{LTRitems}
